...
class ViewController: UIViewController {
    ...
    func setUpThirdContainer(containerView: UIView){
        ...
        self.creditsLabel.font = UIFont(name: "Menlo_Bold", size: 16)
        self.creditsLabel.sizeToFit()
        self.creditsLabel.center = CGPoint(x: containerView.frame.width * kSixth, y: containerView.frame.height * kThird)   //  1/6 across
        ...
        self.betLabel.font = UIFont(name: "Menlo_Bold", size: 16)
        self.betLabel.sizeToFit()
        self.betLabel.center = CGPoint(x: containerView.frame.width * kSixth * 3, y: containerView.frame.height * kThird)   //   3/6 hence half way across
        ...
        self.winnerPaidLabel.font = UIFont(name: "Menlo_bold", size: 16)
        self.winnerPaidLabel.sizeToFit()
        self.winnerPaidLabel.center = CGPoint(x: containerView.frame.width * 5 * kSixth, y: containerView.frame.height * kThird)   ///    5/6 across
        ...
        self.creditsTitleLabel.text = "Money"
